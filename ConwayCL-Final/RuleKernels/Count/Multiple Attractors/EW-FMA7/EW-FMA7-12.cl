...
//Get gliders to be birthed from wave's crystal form
	...
	if(count >= 31 && count <= 77) {c_out = 0;}
	if(count >= 88 && count <= 155) {c_out = 0;}
	if(count >= 41 && count <= 43) {c_out = a[my_id]+1;}
	if(count >= 79 && count <= 83) {c_out = a[my_id]+1;}
	if(count >= 119 && count <= 159) {c_out = a[my_id]+1;}
	//if(count >= 84 && count <= 118) {c_out = 0;}
	...
	if(count >= 8 && count <= 8) {c_out = a[my_id]+1;}	
	...
	if(count >= 215) {c_out = 0;}
	if(count >= 239 && count <= 290) {c_out = a[my_id] + 1;}	
