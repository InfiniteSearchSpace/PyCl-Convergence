__kernel void RunAutomata(const int ySize, __global int* a, __global int* c)
{
	...
	if(count >= 28 && count <= 35) {c_out = a[my_id]+1;} 
	if(count > 40 && count < 47) {c_out = 0;}
	if(count < 25) {c_out = 0;}
...
//:17,17,1,
	...
	if(count >= 205 && count <= 285) {c_out = a[my_id]+1;}
	if(count >= 124 && count <= 129) {c_out = a[my_id]+1;}
	if(count >= 81 && count <= 86) {c_out = a[my_id]+1;}
	if(count >= 62 && count <= 66) {c_out = a[my_id]+1;}
	if(count >= 24 && count <= 25) {c_out = a[my_id]+1;}

	if(count >= 95 && count <= 123) {c_out = 0;}
