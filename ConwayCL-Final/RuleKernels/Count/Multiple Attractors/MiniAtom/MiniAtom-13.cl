...
//:17,17,1,
	...
	if(count >= 180 && count <= 220) {c_out = a[my_id]+1;}
	if(count >= 97 && count <= 100) {c_out = a[my_id]+1;}
	if(count >= 72 && count <= 74) {c_out = a[my_id]+1;}
	//if(count == 23) {c_out = a[my_id]+1;}
	if(count >= 150 && count <= 179) {c_out = 0;}
	if(count >= 290) {c_out = 0;}
